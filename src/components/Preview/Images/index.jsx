  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="flex items-center justify-center relative w-full h-full -z-10 overflow-x-clip">
        ...
        <svg className="block md:hidden h-[683px] xxs:h-[380px] xs:h-[520px] top-0 absolute" width="770"  viewBox="0 0 770 683" fill="none" xmlns="http://www.w3.org/2000/svg">
