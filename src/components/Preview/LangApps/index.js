...
let LangApp = (props) => {
  ...
  return (
    <div className="flex flex-col min-h-screen min-w-full bg-[#CA182B] items-center">
      ...
      >
        <h1 className="text-lg xs:text-2xl font-bold text-center mb-[8px] xs:mb-[14px]"> {t('main.header')}</h1>
        <p className="w-full mb-[10px] text-sm xs:text-base">{t('main.base')}</p>
        <div className="flex flex-col items-center justify-center w-full bg-white pb-[31px] mb-[22px] mt-[35px] xs:mt-[48px] rounded-[10px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
          <img 
          src="/images/images/new/nourish.png" 
          className="w-[100px] -mt-[38px] mb-[10px] xs:mb-[25px] border-[1px] border-black rounded-[5px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]" 
          width="200" 
          height="200" alt="" />
          <p className="w-full text-[#767C83] mb-[10px] xs:mb-[20px] px-[15px] text-[13px] xs:text-lg">{t('main.description')}</p>
          <div
            style={{
              height: "auto",
              width: "100%",
          ...
          >
            ...
            >
              ...
              >
                <Typography style={{ fontSize: 10, lineHeight: "10px", }}> {t('main.download')}</Typography>
            ...
            >
              ...
              <div
                ...
                className="text-left rtl:text-right"
              >
                <Typography style={{ fontSize: 10, lineHeight: "10px", }}>{t('main.get')}</Typography>
            ...
            >
              ...
              <div
                ...
                className="text-left rtl:text-right"
              >
                <Typography style={{ fontSize: 10, lineHeight: "10px", }}> {t('main.available')}</Typography>
                <Icon
                  style={{
                    height: "auto",
                    width: "auto",
        ...
        <div className="flex flex-row justify-between items-center bg-white w-full mb-[30px] cursor-pointer p-[10px] rounded-[4px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
