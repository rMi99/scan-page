    ...
    <div className="flex flex-col justify-center items-center">
      <div className="flex flex-col items-center justify-center w-full max-w-[600px] relative">
        <div className="flex items-center w-full">
          ...
          <div className="absolute top-10 xsm:top-12 sm:top-20 right-4 w-[38px] h-[38px] xsm:w-[48px] xsm:h-[48px] bg-white/[.15] rounded-[4px] mb-[18px] xs:mb-[25px] border-[1px] border-white/[1] cursor-pointer flex items-center justify-center">
        ...
        <div className="flex flex-col w-full px-[20px] mt-6 mb-10">
          <p className="text-black font-bold text-start text-base xxs:text-lg xs:text-2xl sm:text-3xl mb-3">Designer's world (Ui/Ux)</p>
          <p className=" text-[#767C83] text-start text-xs xxs:text-sm xs:text-base mb-3">This is Best UI/ UX designer & developer group community, don't hesitate post requests for help on design themes.</p>
        </div>
        <div className="flex flex-col w-full px-[20px] space-y-[12px] mb-5">
          <div className="flex items-center justify-center py-4 rounded-[4px] space-x-[4px] bg-[#0866FF]">
            ...
            <p className="text-white font-medium text-[10px] xxs:text-sm xs:text-base sm:text-lg">Like 5.8 k</p>
          </div>
          <div className="flex items-center justify-between py-4 px-4 rounded-[4px] space-x-[4px] bg-white border-[1px] border-[#1D5CF9]/[.08] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
            <p className="text-[#0866FF] font-medium text-start truncate text-[10px] xxs:text-sm xs:text-base sm:text-lg">Go to our Facebook page</p>
