...
let AppsPreview = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen  min-w-full bg-[#CA182B] items-center">
      <div
        className="flex flex-col items-center justify-center text-white mt-[50px] xs:mt-[60px] w-full max-w-[450px] px-[16px]" style={{fontFamily : 'GT Walsheim Pro'}}
      >
        ...
        <div className="flex flex-col items-center justify-center w-full bg-white pb-[31px] mb-[22px] mt-[35px] xs:mt-[38px] rounded-[10px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
...
let AppsShowcase = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen  min-w-full bg-[#CA182B] items-center" ref={container}>
      <div
        className="flex flex-col items-center justify-center text-white mt-[65px] w-full max-w-[450px] px-[10px]" style={{fontFamily : 'GT Walsheim Pro'}}
      >
        <h1 className="text-lg font-bold text-center mb-[8px]">Nourish</h1>
        <p className="w-full text-xs">{t('app.base')}</p>
        <div className="flex flex-col items-center justify-center w-full bg-white pb-[31px] mb-[22px] mt-[46px] rounded-[10px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
          <img src="/images/images/new/nourish.webp" className="w-[70px] -mt-[28px] mb-[15px] border-[1px] border-black rounded-[5px] shadow-xl" width="200" height="200" alt=""/>
          <p className="w-full text-[#767C83] mb-[13px] px-[15px] text-[13px]">{t('app.description')}</p>
          <div className="w-full h-auto px-3">
            <Card className="hover:opacity-70 active:opacity-[.85] cursor-pointer w-full"
              style={{
                backgroundColor: "black",
                height: "auto",
            ...
            >
              ...
              >
                <Typography style={{ fontSize: 9.5, lineHeight: "10px", }}> {t('app.download')}</Typography>
                <Typography style={{ fontWeight: "bold", fontSize: 17.5, lineHeight: "20px", }}>
                App Store
                </Typography>
              </div>
            </Card>
            ...
            >
              ...
              >
                <Typography style={{ fontSize: 8.5, lineHeight: "10px" }} sx={{textTransform:"uppercase"}}> {t('app.get')}</Typography>
                <Typography style={{ fontWeight: "medium", fontSize: 15.5, lineHeight: "20px", }}>Google Play</Typography>
              </div>
            </Card>
            <Card className="hover:opacity-70 active:opacity-[.85] cursor-pointer w-full"
              style={{
            ...
            >
              ...
              >
                <Typography style={{ fontSize: 11.5, lineHeight: "10px", }}> {t('app.available')}</Typography>
                <Icon
                  style={{
                    height: "auto",
                    width: "auto",
        ...
        <button className="flex flex-row justify-between items-center bg-white w-full mb-[30px] cursor-pointer p-[10px] rounded-[4px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
          <div className="space-x-[5px] xss:space-x-[15px] w-full mr-[5px] flex flex-row">
            <div className="w-[45px] h-[45px] min-w-[30px] rounded-[4px] bg-[#F9F9F9] flex justify-center items-center mr-[5px]">
              <svg width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.0003 21.5781C6.31741 21.5781 1.69824 17.0594 1.69824 11.5C1.69824 5.94063 6.31741 1.42188 12.0003 1.42188C17.6832 1.42188 22.3024 5.94063 22.3024 11.5C22.3024 17.0594 17.6832 21.5781 12.0003 21.5781ZM12.0003 2.82812C7.11283 2.82812 3.13574 6.71875 3.13574 11.5C3.13574 16.2812 7.11283 20.1719 12.0003 20.1719C16.8878 20.1719 20.8649 16.2812 20.8649 11.5C20.8649 6.71875 16.8878 2.82812 12.0003 2.82812Z" fill="#767C83" />
                <path d="M9.12547 20.6406H8.16714C7.77422 20.6406 7.44839 20.3219 7.44839 19.9375C7.44839 19.5531 7.75505 19.2437 8.14797 19.2344C6.64339 14.2094 6.64339 8.79063 8.14797 3.76562C7.75505 3.75625 7.44839 3.44687 7.44839 3.0625C7.44839 2.67812 7.77422 2.35938 8.16714 2.35938H9.12547C9.35547 2.35938 9.57589 2.47187 9.71005 2.65C9.84422 2.8375 9.88255 3.07187 9.80589 3.2875C8.00422 8.58437 8.00422 14.4156 9.80589 19.7219C9.88255 19.9375 9.84422 20.1719 9.71005 20.3594C9.57589 20.5281 9.35547 20.6406 9.12547 20.6406Z" fill="#767C83" />
                <path d="M14.8753 20.6405C14.7986 20.6405 14.722 20.6311 14.6453 20.603C14.2715 20.4811 14.0607 20.078 14.1949 19.7124C15.9965 14.4155 15.9965 8.58427 14.1949 3.27802C14.0703 2.91239 14.2715 2.50927 14.6453 2.38739C15.0286 2.26552 15.4311 2.46239 15.5557 2.82802C17.4628 8.41552 17.4628 14.5655 15.5557 20.1436C15.4599 20.453 15.1724 20.6405 14.8753 20.6405Z" fill="#767C83" />
...
export {AppsPreview,AppsShowcase};
