  ...
  return (
    <div className="flex flex-col justify-center items-center" ref={container}>
      <div className="flex items-center justify-center relative w-full h-full -z-10 overflow-x-clip">
        ...
        <svg className="md:hidden top-0 absolute" width="770" height="275" viewBox="0 0 770 364" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 0H770V354.616C770 354.616 648.853 333.501 385 354.616C121.147 375.73 0 354.616 0 354.616V0Z" fill="#093A32" />
        </svg>
      </div>
      <div className="flex flex-col items-center justify-center mt-[64px] w-full max-w-[700px] px-[16px] pb-[25px]" >
        <img src="/images/images/new/avatar.webp" className="w-[98px] border-[5px] rounded-full border-white shadow-[1px_6px_30px_rgba(0,31,14,0.05)]" width="240" height="240" alt=""/>
        <div className="mt-[15px]">
          <h1 className="text-white text-lg xs:text-2xl mb-[3px] font-bold">John Carlson</h1>
          <h2 className="text-[#CED8D6] text-xs xs:text-lg">{t('vcard.profession')}</h2>
        </div>
        <div className="flex flew-row space-x-[15px] xs:space-x-[27px] mt-[22px] xs:mt-[25px] rtl:space-x-0 rtl:gap-5 rtl:columns-3">
          <div className="flex items-center justify-center w-[42px] xs:w-[62px] h-[42px] xs:h-[62px] bg-white rounded-full cursor-pointer hover:opacity-95 hover:scale-105 shadow-md">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[18px]">
              <mask id="mask0_797_11738" maskUnits="userSpaceOnUse" x="2" y="2" width="21" height="21">
                <path fillRule="evenodd" clipRule="evenodd" d="M2 2.00024H22.4996V22.4997H2V2.00024Z" fill="white" />
              </mask>
              <g mask="url(#mask0_797_11738)">
        ...
        <p className="text-xs xs:text-lg text-[#767C83] text-center mt-3">
          {t('vcard.summary')}
        </p>
        <div className="w-full">


          <div className="mt-3 py-[18px] px-[12px] xs:p-[20px] rounded-[4px] flex flex-col items-start justify-center w-full shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
            {/* phone */}
            <button className="flex flex-row space-x-[10px] xs:space-x-[16px] w-full cursor-pointer hover:opacity-80">
              <div className="bg-[#F9F9F9] p-[9px] rounded-full w-8 h-8 rtl:ml-2">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5">
                  <mask id="mask0_797_11795" maskUnits="userSpaceOnUse" x="1" y="1" width="16" height="16">
                    <path fillRule="evenodd" clipRule="evenodd" d="M1.5 1.50024H16.8747V16.8749H1.5V1.50024Z" fill="white" />
                  </mask>
                  <g mask="url(#mask0_797_11795)">
              ...
              <div className="flex-col text-left rtl:text-right">
                <p className="text-[9px] text-[#767C83]">{t('vcard.phone')}</p>
                <p className="text-[12px] xs:text-base text-black font-medium">555-100-1000</p>
              </div>
            </button>
            <div className="w-full h-[1px] my-[9px] bg-[#F2F2F2] rounded-full"></div>
            {/* email */}
            <button className="flex flex-row space-x-[10px] xs:space-x-[16px] w-full cursor-pointer hover:opacity-80">
              <div className="bg-[#F9F9F9] p-[11px] rounded-full w-10 h-10 rtl:ml-2">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex-col text-left truncate rtl:text-right">
                <p className="text-[9px] text-[#767C83]">{t('vcard.email')}</p>
                <p className="text-sm xs:text-base text-black font-medium truncate">John.Carlson@gmail.com</p>
              </div>
            </button>
            <div className="w-full h-[1px] my-[15px] bg-[#F2F2F2] rounded-full"></div>
...
export {VcardPreview,VcardShowcase};