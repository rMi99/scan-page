  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="flex items-center justify-center relative w-full h-full -z-10 overflow-x-clip">
        <svg className="hidden md:block top-0 absolute" width="2066" height="357" viewBox="0 0 2066 357" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 0H2066V343.426C2066 343.426 1616.99 312.884 1033 343.426C449.011 373.968 0 343.426 0 343.426V0Z" fill="#707BFF" />
        </svg>
        <svg className="block md:hidden top-0 absolute" width="770" height="320" viewBox="0 0 770 357" fill="none" xmlns="http://www.w3.org/2000/svg">
