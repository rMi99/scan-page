...
let BusinessPreview = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center relative">
      <div  className="bg-[#1A97F0] bottom-3 right-3 fixed z-50 p-2 rounded-md cursor-pointer" >
      ...
      <div
        ...
        >
        <h1 className="text-white text-lg xs:text-xl font-medium mb-[14px] xs:mb-[49px]">Boulangerie Pâtissier</h1>
        <div className="w-full bg-white flex flex-col justify-center items-center p-[8px] rounded-[4px] mb-[10px] xs:mb-[20px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
          ...
          <h2 className="text-[#767C83] text-sm xs:text-base mb-[10px] xs:mb-[14px] ">{t('bushiness.subtitle')}</h2>
        ...
        <div className="w-full flex flex-col justify-center items-center rounded-[4px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)] p-[10px] mb-[20px]">
          <div className="flex flex-row justify-start items-center space-x-[8px] xs:space-x-[17px] w-full mb-[10px]">
            ...
            <p className="font-medium text-sm xs:text-base sm:text-xl text-black">{t('bushiness.open_hours')} - <span className="text-green-600">{t('bushiness.open_now')}</span></p>
          </div>
        ...
        <div className="w-full flex flex-col items-start justify-center mb-[20px]">
          ...
          <div className="w-full space-y-[15px]">
            ...
            <div className="my-[5px] flex flex-col w-full cursor-pointer shadow-[1px_6px_30px_rgba(0,31,14,0.05)] hover:opacity-80">
              <div className="flex flex-row justify-between items-center p-[10px] rounded-[4px]">
                <div className="space-x-[10px] xs:space-x-[20px] flex flex-row items-center">
                  <img src="/images/social/facebook.png" width="132" height="132" className="w-[44px] rtl:ml-2" alt=""/>
                  <p className="text-base xs:text-xl text-[#131D29] font-medium">Facebook</p>
                </div>
                <svg className="mr-[5px] rtl:rotate-180" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="my-[5px] flex flex-col w-full cursor-pointer shadow-[1px_6px_30px_rgba(0,31,14,0.05)] hover:opacity-80">
              <div className="flex flex-row justify-between items-center p-[10px] rounded-[4px]">
                <div className="space-x-[10px] xs:space-x-[20px] flex flex-row items-center">
                  <img src="/images/social/instagram.png" width="132" height="132" className="w-[44px] rtl:ml-2" alt=""/>
            ...
            <div className="my-[5px] flex flex-col w-full cursor-pointer shadow-[1px_6px_30px_rgba(0,31,14,0.05)] hover:opacity-80">
              <div className="flex flex-row justify-between items-center p-[10px] rounded-[4px]">
                <div className="space-x-[10px] xs:space-x-[20px] flex flex-row items-center">
                  <img src="/images/social/google.png" width="132" height="132" className="w-[44px] rtl:ml-2" alt=""/>
            ...
            <div className="my-[5px] flex flex-col w-full cursor-pointer shadow-[1px_6px_30px_rgba(0,31,14,0.05)] hover:opacity-80">
              <div className="flex flex-row justify-between items-center p-[10px] rounded-[4px]">
                <div className="space-x-[10px] xs:space-x-[20px] flex flex-row items-center">
                  <img src="/images/social/linkedin.png" width="132" height="132" className="w-[44px] rtl:ml-2" alt=""/>
            ...
            <div className="my-[5px] flex flex-col w-full cursor-pointer shadow-[1px_6px_30px_rgba(0,31,14,0.05)] hover:opacity-80">
              <div className="flex flex-row justify-between items-center p-[10px] rounded-[4px]">
                <div className="space-x-[10px] xs:space-x-[20px] flex flex-row items-center">
                  <img src="/images/ListOfLinks/tiktok.png" width="132" height="132" className="w-[44px] rtl:ml-2" alt=""/>
...
let BusinessShowcase = () => {
  const t = useLanguage();
  const container = useAdjustZoom();

  return (
    <div className="flex flex-col justify-center items-center relative" ref={container}>
      <div className="bg-[#1A97F0] bottom-3 right-3 fixed z-50 p-2 rounded-md cursor-pointer">
        <svg width="30px" height="30px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" className="bi bi-three-dots-vertical">
          <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
        </svg>
      ...
      <div className="flex items-center justify-center relative w-full h-full -z-10 overflow-x-clip" >
        ...
        <svg className="md:hidden top-0 absolute" width="770" height="250" viewBox="0 0 770 348" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 0H770V321.625C770 321.625 581.093 262.282 385 321.625C188.907 380.968 0 321.625 0 321.625V0Z" fill="#1A97F0"/>
        </svg>
      </div>
      <div className="flex flex-col items-center justify-center mt-[50px] xs:mt-[73px] w-full max-w-[700px] px-[16px]" >
        <h1 className="text-white text-[14px] font-medium mb-[14px]">Boulangerie Pâtissier</h1>
        <div className="w-full bg-white flex flex-col justify-center items-center px-[7px] py-1 rounded-[4px] mb-[10px] xs:mb-[20px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)]">
          <img src="/images/images/new/business.webp" className="w-full h-full" width="330" height="270" alt=""/>
          <h1 className="text-black text-lg my-[10px] font-bold">Boulangerie Pâtissier</h1>
          <h2 className="text-[#767C83] text-xs mb-[10px]">{t('bushiness.subtitle')}</h2>
          <div className="w-full flex justify-center items-center bg-[#0079FF] rounded-[4px] py-[10px] cursor-pointer hover:opacity-80">
            <p className="text-xs text-white font-medium">{t('bushiness.button')}</p>
          </div>
        </div>
        <div className="w-full flex flex-col justify-center items-center rounded-[4px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)] p-[10px] mb-[20px]">
          <div className="flex flex-row justify-start items-center space-x-[8px] xs:space-x-[17px] w-full mb-[10px]">
        ...
        <div className="w-full flex flex-col justify-center items-center rounded-[4px] shadow-[1px_6px_30px_rgba(0,31,14,0.05)] p-[10px] mb-[20px]">
          ...
          <div className="flex flex-col items-center justify-center w-full px-[10px] mb-[10px] mt-[20px] space-y-[25px]">
            ...
            <div className="flex flex-row items-center space-x-[16px] w-full cursor-pointer hover:opacity-80">
              ...
              <div className="flex-col text-left truncate">
                <p className="text-xs text-[#767C83]">{t('bushiness.Website')}</p>
                <p className="text-sm xs:text-base text-[#0079FF] font-medium truncate">www.boulangerie.com</p>
              </div>
            </div>
...
export {BusinessPreview,BusinessShowcase};
